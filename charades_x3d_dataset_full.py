...
class Charades(data_utl.Dataset):
    ...
    def __init__(self, split_file, split, root, mode, transforms=None, save_dir='', num=0, resize_size=256):
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'rgb':
            imgs = load_rgb_frames(self.root, vid, 1, nf, self.resize_size)
        else:
            imgs = load_flow_frames(self.root, vid, 1, nf, self.resize_size)
